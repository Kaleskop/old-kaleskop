<form method="POST" action="{{ route( 'plans.update', $plan ) }}">
 ...
 <fieldset class="mb-8 p-4 border border-black">
  ...
  <div class="mb-4">
   ...
   <input type="text" name="name" id="name" class="appearance-none w-full py-2 px-4 rounded border-2 border-black leading-tight" value="{{ $plan->name }}" required autofocus />
 ...
 <fieldset class="mb-8 p-4 border border-transparent">
  ...
  <div class="mb-4">
   ...
   <input type="text" name="product_id" id="product_id" class="appearance-none w-full py-2 px-4 rounded border-2 border-black leading-tight" value="{{ $plan->product_id }}" required />
  ...
  <div class="mb-4">
   ...
   <input type="text" name="product_name" id="product_name" class="appearance-none w-full py-2 px-4 rounded border-2 border-black leading-tight" value="{{ $plan->product_name }}" required />
  ...
  <div>
   ...
   <input type="text" name="plan_id" id="plan_id" class="appearance-none w-full py-2 px-4 rounded border-2 border-black leading-tight" value="{{ $plan->plan_id }}" required />
